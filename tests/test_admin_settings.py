...
def test_the_model_table_status_chip_is_the_switch_s_own_box():
    """The chip in the Status column stands beside the pin switch, so it is the
    ...
    assert 'class="badge badge--accent"' in SETTINGS          # loaded (virtual)
    assert ':class="hover ? \'badge--red cursor-pointer\' : \'badge--accent\'"' in SETTINGS
